...
I was started with a periodic_table database that has information about some chemical elements and have completed all of the "Periodic Table Database" tasks and user stories below in order to finish the project. After getting all the tests to pass, I saved [a copy of the PostgreSQL dump file 'periodic_table.sql' of my solution's database](https://github.com/Rami24t/Periodic-Table-Database/blob/main/element.sh](https://github.com/Rami24t/Periodic-Table-Database/blob/main/periodic_table.sql), as well as [the final version of 'element.sh' my solution's bash script file](https://github.com/Rami24t/Periodic-Table-Database/blob/main/element.sh), into this public repository.
